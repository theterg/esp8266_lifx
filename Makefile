...
# The following lines may be commented out if the xtensa-lx106-elf binaries
# are not already added to your system path:
# TOOLS = /path/to/esp-open-sdk/xtensa-lx106-elf/bin
# PATH := $(PATH):$(TOOLS)

# Expand relative path
SDK_RELATIVE=./sdk/ESP8266_RTOS_SDK
export SDK_PATH = $(realpath $(SDK_RELATIVE))
export BIN_PATH = ../bin
export COMPILE = gcc
########################
...
# EDIT THESE to suit the ESP8266 board you are using
#
